...
\emph{Functional requirements} can be seen in the Table~\ref{tab:requirements-with-scope}. ``Must have'' requirements form the minimal viable product (MVP). Out of all requirements, I have created user stories that can be seen in the list below.
