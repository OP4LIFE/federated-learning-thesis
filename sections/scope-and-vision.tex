...
The scope can be seen on the table~\ref{tab:requirements-with-scope} on page~\pageref{tab:requirements-with-scope}. The requirements include terminology described in section~\ref{sec:preliminary-research}. ``Must have'' features describe the minimal viable product (MVP); without these, the project is not deemed finished, unless blockers are clearly stated.
