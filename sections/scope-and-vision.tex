...
The scope includes terminology described in section~\ref{sec:preliminary-research}. Must have requirements describe the minimal viable product (MVP). \newline

\begin{table}[htb]\centering
\caption{Requirements with their importance}\label{tab:test}
 \csvreader[
