...
Ultimate scope of the project is defined with features of ``Should have'' and ``Could have'' importance in the Table~\ref{tab:requirements-with-scope} on page~\pageref{tab:requirements-with-scope}. As importance lowers, features become closer to those of realistic setting in which federated learning could be deployed, and more unknown challenges might appear.