...
A summary of final metrics from both centralized and federated approaches can be seen in Table~\ref{tab:second-test}. The differance between these two machine learning techniques, in terms of metrics, turn out to be very minor, around 0.03 $\pm$ 0.05, with federated learning mostly having slightly lower values; except for the test metrics, where we suspect a minor bug in the code. Results of another test can be found in Appendix~\ref{appendix:second-test}, all tests and project code can also be found on GitHub\footnote{https://github.com/MatejVeselUCLL/federated-learning-approach-for-obstructive-sleep-apnea-prediction}.
