...
\begin{table}[htb]\centering
    \caption{Functional requirements with their importance and completion status, higher rows correspond to higher priority.}\label{tab:requirements-with-scope-and-completion}
    \csvreader[
